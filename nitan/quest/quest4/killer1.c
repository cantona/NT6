...
//here begin to set_skill of this_object()
        ...
        else if(exp>6000000) title+=MAG"   武林宗師"NOR;
        else if(exp>4000000) title+=HIB"   威震一方"NOR;
        else if(exp>2000000) title+=RED"   聲名赫赫"NOR;
        else if(exp>1000000) title+=HIC"   當世英傑"NOR;
...
+HIB"殺死了"NOR+HIR+me->query("name")+NOR+HIB"，獲得了"
