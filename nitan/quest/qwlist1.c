...
//  ([  "quest":  "[1;36m青衫[2;37;0m"]),  
  ...
  ([  "quest":  "灰色道袍"]),
  ([  "quest":  "白色道袍"]),                           
//wudujiao (去掉"鐵哨"、"土豆"、"柿餅"、"銅牌"、"金鈎"、"解毒丹"、"金蛇毒液")
  ([  "quest":  "竹簍"]),                               
  ([  "quest":  "土豆"]),                               
  ([  "quest":  "柿餅"]),                               
  ([  "quest":  "金蛇毒液"]),                               
...
//  ([  "quest":  "[1;33m米飯[2;37;0m"]),
  ...
  ([  "quest":  "[1;35m紫氲正譜[2;37;0m"]),
  ([  "quest":  "[1;35m紫氲次譜[2;37;0m"]),
  ([  "quest":  "[1;35m紫氲外譜[2;37;0m"]),
  ([  "quest":  "「九陽真經」第一卷"]),
  ([  "quest":  "「九陽真經」第二卷"]),
  ([  "quest":  "「九陽真經」第三卷"]),
  ([  "quest":  "「九陽真經」第四卷"]),
