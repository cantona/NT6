...
int main(object me, string arg)
{
	...
	int n;
        ...
        if (me->is_busy()) 
                return notify_fail(CYN"你現在正忙着呢！還想幹嘛？\n"NOR);
        ...
        if(obj==me)     return notify_fail(HIW" 強姦自己? 沒聽説過！\n"NOR);
    ...
    && !obj->query_condition("pker"))
       ...
       if((int)obj->query("per") > 22){                //考慮到差異，所以這裏要分支
...
{
        if(objectp(present(obj,environment(me)))){
      message_vision(HIC"\n$n對着$N大喝一聲:"+RANK_D->query_rude(me)+"，想走? 沒門！嚐嚐本"+RANK_D->query_respect(obj)+"厲害再説！\n"NOR,me, obj);   
...
void do_puke(object me, object obj)
{
     if(objectp(present(obj, environment(me)))) {
        message_vision(CYN"\n$N稀里哇啦地吐了一地。\n"NOR, me,obj);
        tell_object(me,HIY"你不由得對自己説：天啦，這世上還有這麼醜的女人，我還是站遠些好！\n"NOR);    
        message_vision("\n$N遠遠地推開$n,苦笑着説："+RANK_D->query_respect(obj)+"，如此‘尊容’，在下實在無福消受\n剛才唐突，還望見諒，咋們後會無期！\n",me,obj); 
        message_vision(CYN"\n接着$N又是一陣狂吐。\n"NOR,me,obj);
        me->start_busy(1);
        obj->start_busy(1);
}
...
void do_qiangjian1(object me,object obj)  
{
        ...
        if(objectp(present(obj, environment(me)))) {
        message_vision("接着，$N的大手不顧$n的掙扎在$n的身上來回上下游走.......\n", me, obj);   
...
void do_qiangjian2(object me,object obj)  
{
        ...
        if(objectp(present(obj, environment(me)))) {
        message_vision("\n好一會兒,$N再也按捺不住心中的慾火，將$n身上的衣物一件一件地扯下\n", me, obj);
...
{      
        ...
        if((int)obj->query("age") <= 30 ) {
         ...
         message_vision(HIM"\n雖説已不再是處女,但身為少婦的$n那豐滿的身體曲線也讓$N垂涎三尺!\n"NOR, me, obj);
...
//           me->add("potential", -random((int)me->query("potential")/4));       
         ...
         message_vision(HIM"\n看來$N已經飢渴到飢不擇食的地步了,連$n這樣的老太太也不放過!\n"NOR, me, obj);
         message_vision(HIW"\n小心招天譴!!!\n"NOR, me, obj);
...
void do_qiangjian7(object me,object obj)  
{
        ...
        if(objectp(present(obj, environment(me)))) {
        message_vision("\n$N騎在$n身上，用手撫摸着$n的雙乳。\n"NOR, me, obj);
        message_vision("。。。四周充斥着$N那野獸般的吼叫聲和$n撕心裂肺的哭聲。。。\n", me, obj);
}
...
void do_qiangjian8(object me,object obj)  
{
        ...
        if(objectp(present(obj, environment(me)))) {
        message_vision(HIM"\n良久，風停雨歇。。。。\n"NOR, me, obj);
        message_vision("$N掙扎着爬了起來，對着昏睡在地的$n滿足地淫笑了一下。\n", me, obj);
...
void do_qiangjian10(object me,object obj)  
{
        ...
        if(objectp(present(obj, environment(me)))) {
        message_vision(HIM"\n良久，風停雨歇。。。。\n"NOR, me, obj);
        message_vision("$N爬了起來，對着昏睡在地的$n失望地歎了一下氣：真他媽的倒黴,讓老子遇到這種'水貨'。\n", me, obj);
}
        return;
}
...
void do_kill(object me,object obj)    
{
         ...
         if((int)obj->query("age") <= 18)
     {
      message_vision(HIC"\n$n滿面淚痕地對着$N大喝一聲:"+RANK_D->query_rude(me)+"休逃，你毀我貞操，我和你拼了！\n\n"NOR,me, obj);
                me->kill_ob(obj);
                obj->kill_ob(me);
     }else{  
         if((int)obj->query("age") <= 30)
     {
      message_vision(HIC"\n$n滿面淚痕地對着$N大喝一聲:"+RANK_D->query_rude(me)+"休逃，你污我身體，讓我怎生作人,\n索性和你拼了！\n\n"NOR,me, obj);
                me->kill_ob(obj);
                obj->kill_ob(me);
     }else{         
         if((int)obj->query("age") <= 55){
           message_vision(HIW"\n$n對着$N大喝一聲:"+RANK_D->query_rude(me)+"休逃，你辱我清白，我和你拼了！\n\n"NOR,me, obj);
                me->kill_ob(obj);
                obj->kill_ob(me);
     }else{
           message_vision(HIW"\n$n對着$N大喝一聲:"+RANK_D->query_rude(me)+"休逃，你讓我晚節不保，我這條老命還留着作甚，\n索性和你拼了\n\n"NOR,me, obj);
                me->kill_ob(obj);
                obj->kill_ob(me);
     }
     }
