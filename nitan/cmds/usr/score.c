...
*/              {
        ...
        */
        ...
        line += sprintf( YEL "┃                                                                ┃\n" NOR );
        line += sprintf( YEL "┃" NOR HIY " 武學宗師： %s" NOR HIY "    大小週天： %s" NOR HIY "   元嬰出世： %s" NOR HIY "    生死玄關：%s " NOR YEL "┃\n" NOR,
        ...
        msg = "";
        if( (int)mci["dietimes"])
                msg = sprintf(HIB " 你到目前為止總共到黑白無常那裏"
                                "串門%s次。" NOR,
        ...
        line += sprintf( WHT " □%s在" HIG + CHINESE_MUD_NAME + NOR "裏的遊戲時間是:" HIY "%s \n\n" NOR,
