...
string *parry_msg = ({
         "$p眼見$P$w攻到，當即使出一招「攬雀尾」，右腳實，左腳虛，運起“擠”字訣，粘連粘隨，右掌已搭住$P左腕，橫勁發出。$N身不由主的向前一沖，跨出兩步，方始站定。\n",
...
([      "action" : "$N左手變掌橫于胸前，右拳由肘下穿出，一招"+(order[random(13)])+"「肘底看錘」"NOR"，錘向$n的$l",
        "skill_name" : "肘底看錘",
        "lvl" : 30
]),
...
([      "action" : "$N雙手先抱成球狀，忽地分開右手上左手下，一招"+(order[random(13)])+"「野馬分鬃」"NOR"，向$n的$l和面門打去",
        "skill_name" : "野馬分鬃",
        "lvl" : 150
]),
...
([      "action" : "$N雙手經下腹劃弧交于胸前，成十字狀，一式"+(order[random(13)])+"「十字手」"NOR"，向$n的$l打去",
        "skill_name" : "十字手",
        "lvl" : 210
]),
...
([      "action" : "$N身體向後騰出，左手略直，右臂微曲，使一招"+(order[random(13)])+"「倒攆猴」"NOR"，向$n的$l和面門打去",
        "skill_name" : "倒攆猴",
        "lvl" : 270
]),
...
{
        return
        "太極拳，為宋末元初武當張三豐真人所創，合道家之說，沖虛自然，主以慢"
        "打快，以靜制動，後發制人，無為至虛之念的上乘武學。拳出時雙手圓轉，"
        "每一招都含著太極式的陰陽變化，精微奧妙，實是開辟了武學中從所未有的"
        "新天地。訣竅為「虛靈頂勁、涵胸拔背、鬆腰垂臀、沉肩墜肘」十六個字，"
        "純粹以意行，最忌用力。形神合一，是這路拳法的要旨。"
        "太極拳勁首要在于似鬆非鬆，將展未展，勁斷意不斷，其接力打力為武林一絕。";
}
