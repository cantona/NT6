...
int perform(object me, object target)
{
        ...
        message_combatd(BLU"\n$N神色慘淡，伸手打開發髻，長發下垂，覆在臉上，跟著點燃紅磷粉，咬破舌尖，\n"
                "一口"RED"鮮血"BLU"向火燄中噴去。"HIR"火燄忽地一暗，隨即大為"RED"明亮"HIR"，耀得眾人眼睛也不易睜開。\n\n"NOR,me);
...
int check_pfm(object me, object target, object ob)
{
        ...
        ||  environment(me)!=environment(target)){
                message_combatd(HIY"$N衣袖再拂，將抬起的"HIR"火牆"HIY"壓回火燄之中。\n"NOR,me);
                return 1;
        }
        ...
        msg = BLU"\n$N猛地身子急旋，如陀螺般連轉了十多個圈子，接著$P大袖拂動，"HIR"整個火燄堆陡地撥起，凌空\n"
        ...
        if(random(me->query_str()) > target->query_dex()/2){
                msg += HIY"碧燄映照之下$p微一遲疑，那火牆來得快極，便要撲到身上，$p只得雙掌齊出，\n"
                ...
                msg += HIY"\n$n只嚇目瞪口呆，一怔之間，急忙躍起，但一朵"HIW"火花"HIY"已射到身前，嗤的一聲響，\n"
                       "火花已燒上肚腹。$n“啊”的一聲大叫，落了下來。那團"HIR"大火牆"HIY"也即回入火燄堆中。\n" NOR;
...
int start_huoqiang(object me)
{
        ...
        if(!living(target) && living(me)){
                msg = HIR"$N雙掌拍出，一道"GRN"碧燄"HIR"吐出，射向$n。$p此刻已無絲毫還手余地，連站起來逃命的力氣也無。\n"
                      GRN"碧燄"HIR"一射到$p身上，霎時間頭發衫著火，狂叫慘號聲中，全身都裹入"RED"烈燄"HIR"之中。\n"NOR;
        ...
        if(!living(me) && !living(target)){
                ...
                set_temp("last_damage_from", "和"+target->name()+"同歸于盡", me);
                me->die();
                return 0;
        }
        if(!objectp(ob = present("huo yan", environment(me)))){
        ...
        case 185:
                 if(neili > neili2){
                        msg = random(2)?HIR"$N眼看"GRN"碧燄"HIR"$N使出全力，試圖將那步步逼進的碧炎推擋回去！\n"NOR:HIR"$N眼看"GRN"碧燄"HIR"向自己移來，卻不能開口停送真氣，不然碧燄卷將過來，立時會被活活燒死！\n"NOR;
                        message_combatd(msg, target);
                 }
                 break;
        case 36:
        ...
        case 195:
                 if( query("jiali", me)>query("jiali", target)){
                        msg = random(2)?HIR"這片"GRN"碧燄"HIR"在空中略一停滯，便緩緩向$N面前退去，$N大驚，又在舌尖\n"
                              "上一咬，一口"RED"鮮血"HIR"再向火燄噴去，火燄一盛，回了過來！\n"NOR:HIW"$N此時臉上已無半點血色，一口口"RED"鮮血"HIW"不住向火燄中吐去，要將火燄逼回！\n"NOR;
