...
mapping *action = ({
([        "action" : "$N凌空飛起，挽了一個劍花，一招"GRN"「水面風回聚落花」"NOR"，劍光四射就如同千萬點寒星，向$n當頭洒下",
        "lvl"    : 0,
        "skill_name"  : "水面風回聚落花"
]),
([        "action" : "$N驀的向前一縱身，左手單掌護胸，右手手腕一沉，$w向上反撩，一式"HIY"「閒敲棋子落燈花」"NOR"劃向$n的$l",
        "lvl"    : 20,
        "skill_name"  : "閒敲棋子落燈花"
]),
([        "action" : "$N口中輕叱一聲，手中$w向下一點，身形向上拔起丈余，一招"BLU"「駿馬行橋踏落花」"NOR"$w居高臨下如閃電般刺向$n的$l",
        "lvl"    : 30,
        "skill_name"  : "駿馬行橋踏落花"
]),
...
([        "action" : "$N身軀一轉，一招"HIW"「月明殘雪映梅花」"NOR"，內力急吐，$w上突地漲出尺余長的劍芒呼呼作響,劃向$n的$l",
        "lvl"    : 160,
        "skill_name"  : "月明殘雪映梅花"
]), 
...
([        "action" : "$N抱元守一，運力于臂，一招"HIR"「人間處處有紅花」"NOR"，只見劍光閃閃，四下裡劍氣縱橫，$n幾乎要透不過氣來",
        "lvl"    : 180,
        "skill_name"  : "人間處處有紅花"
]),
});
