...
string *pfail_msg = ({
        ...
        "$n手臂回轉，在$N手肘下輕輕一推，然而$N招數忽的一變，並未落空。\n",
        "$n右手伸出，在$N手腕上輕輕一拉，$N收勢不住，順勢變招撲前直擊。\n",
        "$n左牽右引，$N如身處漩流，順勢變招，圓轉如意，隨心所欲。\n",
        "$n雙手回圈，$N只覺得前面好象有一堵牆，猛然警醒，聚力于一點，力攻對方。\n",
});
string *dodge_msg = ({
...
void nuoyi(object ob, object me, int damage)
{
        ...
        msg = HIM "\n$N" HIM "乾坤大挪移第七層心法施展出來，頓將先前所積蓄"
              "的十余道力量歸並為一掌，朝$n" HIM "疾拍而出，這便如一座大湖"
              "在山洪爆發時儲滿了洪水卻突然崩決，洪水急沖而出一般。\n" NOR;
...
至第六層時，全身都能忽紅忽青，但到第七層時，陰陽二氣轉換于
不知不覺之間，外形上便半點也瞧不出表征了。其根本道理也並不
如何奧妙，只不過先求激發自身潛力，然後牽引挪移敵勁，但其中
變化神奇，卻是匪夷所思。

        學習要求：
                基本內功100級並不得低于乾坤大挪移的級別
                九陽神功不得低于乾坤大挪移的級別
                內力1500並不得低于乾坤大挪移的級別的15倍
                太監無法領悟100級以上的乾坤大挪移
HELP
        );
        return 1;
