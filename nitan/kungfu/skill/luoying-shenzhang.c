...
([        "action" : "$N右手五指緩緩一收，一式"HIG"「回風拂柳」"NOR"，五指忽然遙遙拂向$n，$n只覺得五股疾風襲向自己五處大穴",
        "lvl" : 0,
        "skill_name" : "回風拂柳"
]),
...
([        "action" : "$N左手揮起，掌心朝天，伸出右手並攏食指中指，捻個劍決，一式"CYN"「星河在天」"NOR"，直指$n的中盤",
        "lvl" : 20,
        "skill_name" : "星河在天"
]),
...
([        "action" : "$N一式"HIC"「落英漫天」"NOR"，雙掌在身前疾轉，掌花飛舞，舖天蓋地直指向$n。$n只見漫天掌花，眼花繚亂。",
        "lvl" : 99,
        "skill_name" : "落英漫天"
])
});
/*
mapping *action = ({
([      "action" : "$N右手五指緩緩一收，一式「回風拂柳」，五指忽然拂向$n五處大穴",
        "force"  : 80,
        "attack" : 14,
        "dodge"  : 7,
        "parry"  : 8,
...
([      "action" : "$N一式「落英漫天」，雙掌在身前疾轉，掌花飛舞，舖天蓋地直指向$n",
        "force"  : 378,
        "attack" : 84,
        "dodge"  : 41,
        "parry"  : 65,
...
//新增三招
([      "action" : "[1;32m$N一式「柳吉祥」，雙掌如柳絮般在胸前擺動，頓時一道道暗勁快速沖向$n[2;37;0m",
        "force"  : 400,
        "attack" : 200,
        "dodge"  : 200,
        "parry"  : 200,
...
內力向$n湧去，頓時三丈范圍內沙石飛旋，眼見$n已無處可逃[2;37;0m",
        "force"  : 850,
        "attack" : 500,
        "dodge"  : 500,
        "parry"  : 500,
