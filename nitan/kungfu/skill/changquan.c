...
"$N來了個『虛步斷肘』，輕點地面成虛步坐定，右拳順勢向前反沖而上",
"$N右手化掌，『採手沖捶』向前圈採而出，又順勢拉回右手，將左拳向$n擊出",
"$N向前沖出三步，一式『三步行拳』雙拳先右後左，連續向$n直擊而出",
...
"$N雙手右甩左手護肩，一式『回挑沖拳』右手曲肘上架，左拳向$n$l直擊而出",
"$N保持原弓箭步站定不動，一招『順步採手』，雙手以小纏手向上圈採",
"$N撐直左腿步法下壓，『窩肚沖捶』雙手順勢以窩肚捶向$n$l直推而出",
...
明亡後挾技隱居民間，肆機反清復明（有其家譜為証），其後人曾為
乾隆、嘉慶兩朝皇帝的待衛（有石碑為証）。此拳因其家族保守，不
允許其它拳種有丁點滲入，也不允許族人任意改動，故保持了原始的
風貌，傳至我處已歷二十三世。此拳在《紀效新書》、《陣記》、
《少林拳譜》、《玄機秘授穴道拳訣》等許多古代拳譜中均有記載，
但由于其先輩懷珍自秘，故社會傳習較少，現社會中會“太祖四進長拳
”者頗多，但完整繼承此拳種的人卻寥若星辰。
