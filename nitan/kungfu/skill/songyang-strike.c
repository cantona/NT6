...
([        "action" : "$N大喝一聲，使出一路大嵩陽掌法中的"BLU"「鐵樑道」"NOR"，雙掌上下翻飛、大開大闔，連續擊向$n",
        "lvl" : 30,
        "skill_name" : "鐵樑道"
]),
([        "action" : "$N運勁于臂，大吼一聲"HIB"「萬仞壑」"NOR"，左掌拍出，右手成抓，同時襲到，兩股巨力排山倒海般向$n壓了過來",
        "lvl" : 50,
        "skill_name" : "萬仞壑",
]),
...
([        "action" : "$N雙手忽而抓，忽而戳，忽而拳，忽而掌，連變數種，使一套"MAG"「小鐵樑」"NOR"手法，左手一晃，右掌向$n的$l按去",
        "lvl" : 90,
        "skill_name" : "小鐵樑"
]),
