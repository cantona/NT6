...
/*
mapping *action = ({
([        "action" : "$N一立一個翻身，一式「烏龍盤樹」，杖尾霍地橫卷過來，掃擊$n的$l",
        "lvl"    : 0,
        "skill_name" : "烏龍盤樹"
]),
...
([        "action" : "$N手中$w盤旋，左右飛舞宛如銀龍入海，十盪十決，一式「橫雲斷峰」向$n的$l橫掃過去",
        "lvl"    : 40,
        "skill_name" : "橫雲斷峰",
]),
...
([        "action" : "$N使一式「飛燕回翔」，背對著$n，右足一勾，順勢在$w上一點，$w陡然向自己嚥喉疾射，接著$N身子往下一縮，$w掠過其嚥喉，急奔$n急射而來",
        "damage" : 50,
        "force" : 230,
        "dodge" : -45,
        "parry" : -40,
...
([        "action": "$N忽的在地上一個筋鬥，使一招「小憐橫陳」，從$n胯下鑽過，手中$w直擊$n",
        "damage" : 55,
        "dodge": -40,
        "parry": -30,
        "force": 270,
