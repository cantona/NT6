...
string *taiji_msg = ({
         ...
         "$N並非一招一招的相攻，而是以數十招劍法混成的守勢，同時化為攻勢，使$n無法抵御"
});
mapping *action = ({
...
([      "action" : "$N使出"+(order[random(13)])+"「三環套月」"NOR"，$w劃出三個圓圈，劍鋒直出，綿綿不斷劃向$n
的$l",
        "lvl" : 44,
        "skill_name" : "三環套月"
]),
([      "action" : "$N一招"+(order[random(13)])+"「風卷荷葉」"NOR"，$w輕靈地劃出幾個圓弧，迅速地向$n的$l揮去",
        "lvl" : 49,
        "skill_name" : "風卷荷葉"
]),
...
([      "action" : "$N一招"+(order[random(13)])+"「車輪劍」"NOR"，$w化作一片銀盤，平平地向$n的$l卷去",
        "lvl" : 124,
        "skill_name" : "車輪劍"
]),
