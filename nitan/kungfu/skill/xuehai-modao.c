...
([      "action" : CYN"$N低吼一聲，凜然生威，將手中$w"CYN"刀柄反拿，一式「"HIR"血痕累累"CYN"」，卷起片片刀風斬向$n的$l"NOR,
        "skill_name" : "血痕累累",
        "force" : 380,
        "dodge" : 60,
        "lvl" : 90,
...
([      "action" : CYN"$N氣透刀尖，卷起刺骨寒風，一招「"BLU"血風刺骨"CYN"」向前直劈而下，一道紅光從上至下剖向$n的$l"NOR,
        "skill_name" : "血風刺骨",
        "force" : 500,
        "dodge" : 55,
        "lvl" : 100,
...
([      "action" : CYN"$N一式「"HIR"血雨空鳴"CYN"」，一口$w"CYN"越使越快，一團團紅影籠罩了全身，向$n連砍數刀，都是只攻不守，極其凌厲的招數"NOR,
        "skill_name" : "血雨空鳴",
        "force" : 620,
        "dodge" : 10,
        "lvl" : 120,
...
([      "action" : CYN"$N突然橫臥于地，$n目瞪口呆之際，一招「"GRN"破膛刀"CYN"」，手中$w"CYN"由下而上直劈$n的小腹。  "NOR,
        "skill_name" : "破膛刀",
        "force" : 240,
        "dodge" : 5,
        "parry" : 15,
