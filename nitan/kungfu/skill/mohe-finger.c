...
([        "action" : "$N雙手小指向$n揮動，連點三點，接著雙指並攏，一招斜劃，拼成了一個"HIR"「心」"NOR"字",
        "lvl"   : 50,
        "skill_name" : "心"
]),
([        "action" : "$N連連出招，幻出漫天指影，仿佛間竟然形成了一個"HIC"「摩」"NOR"字，照著$n激射而去，越來越快",
        "lvl"   : 60,
        "skill_name" : "摩"
]),
...
([        "action" : "$N雙拳並攏，夾出一個"HIY"「量」"NOR"字來，合力擊向$n，突然下半招一變，右手一指破空擊出",
        "lvl"   : 100,
        "skill_name" : "量"
]),
});
