...
([      "action" : "$N一招「"HIG"無中生有"NOR"」手臂下垂，絕無半點防御姿式，"
...
([      "action" : "$N雙掌平托，一招「"HIM"庸人自擾"NOR"」沒精打採的拍向$n的$l",
        "force"  : 360,
        "attack" : 70,
        "dodge"  : 65,
        "damage" : 45,
...
([      "action" : "$N一招「"RED"倒行逆施"NOR"」突然縱起丈余，頭下腳上，倒過"
                   "身子，一掌拍向$n的$l",
        "force"  : 390,
        "attack" : 80,
        "dodge"  : 70,
...
mixed hit_ob(object me, object victim, int damage_bonus)
{
        ...
        if (random(20) >= 10 && ! victim->is_busy() && j > 140)
        {
                ...
                case 0 :
                        ...
                        msg += HIR"結果$n被這一招「杞人憂天」帶得別說掙紮，竟連站定腳步也是不能。\n"NOR;
