...
mapping *action = ({
([      "action" : "$N屏息靜氣，手起一掌"HIB"「輕煙裊裊」"NOR"，輕輕柔柔地拍向$n",
        "lvl"    : 0,
        "skill_name" : "輕煙裊裊"
]),
...
([      "action" : "$N一招"MAG"「煙海雲濤」"NOR"，雙掌幻化出一片掌影，如一陣輕煙，將$n細細密密地籠罩于內",
        "lvl"    : 40,
        "skill_name" : "煙海雲濤"
]),
([      "action" : "$N返身越出圈外，回首一招"HIC"「雲煙渺渺」"NOR"，遠遠地向$n的$l輕輕拍出兩掌，掌風刮到，陡然變盛直讓$n呼不出氣來",
        "lvl"    : 60,
        "skill_name" : "雲煙渺渺"
]),
([      "action" : "$N左掌從右掌內圍翻出，輕飄飄地向$n拍去，看到$n起手招架，右掌卻自胸口疾速圈出，一招"HIW"「煙霧彌漫」"NOR"，趕超左掌，拍向$n的$l",
        "lvl"    : 80,
        "skill_name" : "煙霧彌漫"
]),
