...
string *all_jiuming = ({
        ...
        "$N一把揪住$n的衣領，揮舞着兵器大聲的吼叫，$n嚇得話都説不出來。\n",
        "$n偷偷從$N腦後狠命敲了一木棍，$N吼叫着迴轉身，搖搖晃晃的朝$n撲去。\n",
        "$N一腳踹開大門，衝進$n家裏，翻箱倒櫃到處亂搜。\n",
        "$n被$N一刀砍中胳膊，驚怒交加，疼痛之下更是不由的大聲慘呼！\n",
        "$n一路奔跑，企圖甩開身後追殺自己的$N，一邊扯着嗓子大喊『救命！』\n",
        "$N殺氣騰騰地提着滴血的兵器，一個跨步就衝到$n面前，劈頭蓋臉地砍將上去。\n",
        "$n和$N打作一團，體力不支漸落下風，牙齒緊咬，怒目圓睜。\n",
        "$N剛從門口消失，$n就從桌子底下爬起來，衝到窗口就大喊：『救命啊！』\n",
        "$N高舉兵器衝着$n吼叫：『把你所有的錢財通通給我交出來，否則我就一刀砍死你！』\n",
        "$N揮舞着兵器高聲叫囂：『想活命的就把錢財都交出來！別讓我等煩了！』\n",
        "$n帶着哭腔大聲喊叫：『救命啊，誰來救救我啊！』\n",
        "$N奸笑着一巴掌將$n打飛出去，搶過了包裹迫不及待的翻過來尋找財物。\n",
        "$N一腳踹開$n，滿臉貪婪的朝錢箱撲了過去。\n",
        "$N一刀將$n砍傷在地，回手一刀又將一隻大狼狗給劈成兩半。\n",
        "$n一邊躲閃着$N的攻擊，一邊後退，氣喘吁吁，眼看快支撐不住了。\n",
});

string *woman_jiuming = ({
        "$N奸笑着衝$n説：『你叫啊，你叫啊，叫破喉嚨也沒人救得了你！』\n",
        "$N一把摟住$n，色迷迷的上下到處亂摸，$n哭叫得聲嘶力竭。\n",
        "$N滿臉淫笑，逼近$n，$n嚇得尖聲驚叫...\n",
        "$N眯着雙眼上下打量$n，一步一步地逼近上前...\n",
        "$n雙拳亂舞，拼命想阻住$N，腳下一滑，摔倒在地，尖聲驚叫起來。\n",
        "$n聲嘶力竭地喊叫：『救命啊，快來救救我啊！』\n",
        "$N一個巴掌將$n抽倒在地，淫笑着撲了上去。\n",
