...
void create()
{
        ...
        set("chat_chance", 3);
        set("chat_msg", ({
                    "小昭低聲吟道：天涯思君不可忘 武當山頂鬆柏長\n",
                    "小昭低聲吟道：寶刀百煉生玄光 字作喪亂意彷徨\n",
                    "小昭低聲吟道：皓臂似玉梅花妝 浮槎北溟海茫茫\n",
                    "小昭低聲吟道：誰送冰舸來仙鄉 窮發十載泛歸航\n",
                    ...
                    "小昭低聲吟道：百尺高塔任回翔 恩斷義絕紫衫王\n",
                    "小昭低聲吟道：四女同舟何所望 東西永隔如參商\n",
                    "小昭低聲吟道：刀劍齊失人雲亡 冤蒙不白愁欲狂\n",
...
int ask_qiankun()
{
        ...
        {
                message_vision( CYN"小昭莞爾一笑，對$N說道：乾坤大挪移心法在本教密道裡，我們去取吧。\n"NOR,me);
                set_leader(me);
