...
void attempt_apprentice(object me)
{
        ...
        {
                command("say 你的江湖經驗太差了，我授徒可是件大事，等過段日子再説吧！");
                return;
        }
...
mixed ask_skill4()
{
        ...
        message_vision(HIY "$n" HIY "大笑數聲，對$N" HIY "説道：“既然你遊身八卦"
                       "掌已有如此\n造詣，我今日便傳你這套掌法的精髓。”説完便只"
...
mixed ask_skill6()
{
        ...
        message_vision(HIY "$n" HIY "微笑着點了點頭，對$N" HIY "道：“你來我八卦"
                       "門修行也有\n好長陣子了，可知道何為「八卦」嗎？”$N" HIY
                       "想也不想，隨口\n答道：“八卦乃天居乾、地居坤、風居巽、雲"
                       "居震、飛龍居\n坎、武翼居兑、鳥翔居離、蜿盤居艮。”$n" HIY
...
mixed ask_dao()
{
        ...
        if (owner == me)
                return "咦？厚背紫金刀現在不正是你拿着嗎，怎麼還反過來問我？";
...
int accept_object(object me, object ob)
{
        ...
        if (base_name(ob) == LETTER)
        {
                ...
                message_sort(HIY "\n$n" HIY "微笑着點了點頭，對$N" HIY "道：“你"
                             "可知道何為「八卦」嗎？”$N" HIY "想也不想，隨口答道"
                             "：“八卦乃天居乾、地居坤、風居巽、雲居震、飛龍居坎、"
                             "武翼居兑、鳥翔居離、蜿盤居艮。”$n" HIY "聽後頗為讚許"
