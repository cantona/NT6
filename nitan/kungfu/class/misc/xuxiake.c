...
mixed ask_map()
{
        ...
        if (sizeof(ks) < 1)
        {
                ...
                if (n < 200)
                {
                        message_sort("$N接過$n的地圖冊，仔細翻了一會兒，歎道：“"
                ...
                tell_object(me, HIG "你仔細翻閲了地圖全集，思索許久，收穫良多，獲"
                                "得了三萬點潛能、兩萬點江湖閲歷和一個練功仙丹。\n" NOR);
                return 1;
        }
