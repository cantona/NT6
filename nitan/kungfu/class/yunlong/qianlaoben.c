...
void create()
{
        ...
        set("chat_chance", 5);
        set("chat_msg", ({
                "錢老本説道：我叫錢老本，就是因為做生意連老本也賠了。\n",
                "錢老本笑着説道：在本店存錢利息至少百分之一，客官您只管存吧。\n",
                "錢老本説：只有對本派弟子我才這麼客氣，對別的人啊，哼哼......\n",
                "錢老本突然説道: 江湖威望很重要，威望值高大有好處啊。\n",
                "錢老本突然説：五人分開一首詩，身上洪英無人知。\n",
        }));
        set("inquiry", ([
                "利息" : "想要利息先入會！\n",
                "陳近南" : "想見總舵主可沒那麼容易。\n",
...
int ask_weiwang()
{
        ...
        say( "錢老本説：如果你威望值很高，有些人見了你不但不會殺你，還會教你武功，送你寶貝。\n而且你還可以加入幫會，率領會眾去攻打目標，就連去錢莊取錢也會有利息 。。。。。\n");
        say("錢老本又説：殺某些壞人或救某些好人可以提高江湖威望。\n");
        return 1;
}
