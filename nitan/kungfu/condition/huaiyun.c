...
int update_condition(object me, int duration)
{
        ...
        if (duration == 400)
        {
                ...
                message("vision", me->name() + HIY "用一種異常慈祥的目光，反復打量著自己的肚子。\n" NOR,
                        environment(me), me);
        } else 
        if (duration == 200)
        {
        ...
        if (duration == 1)
        {
                tell_object(me, HIY "周圍的人都驚訝的合不上了嘴巴，一定是見到了什麼奇怪事情！\n"
                                "看來你是馬上就要生了，請趕緊和孩子的父親去揚州藥舖的二樓產房，否則會有生命危險的！\n" NOR);
...
int birth1(object me)
{
        ...
        if( (query("age", me))<18 )
        {
                message_vision(HIY "\n$N似乎覺得腹中一陣巨痛，大叫一聲，由于$N年齡太小，不適合生育，\n所以$N的孩子流產了，好可憐啊！\n" NOR, me);
                set("qi", 1, me);
                set("jing", 1, me);
        ...
        {
                message_vision(HIY "\n$N似乎覺得腹中一陣巨痛，大叫一聲，由于這裡的環境實在是太惡劣了，\n所以$N的孩子流產了，好可憐啊！\n" NOR, me);
                set("qi", 1, me);
                set("jing", 1, me);
                set("neili",query("neili",  me)/2, me);
                set("long",query("longbak",  me), me);
        ...
        {
                message_vision(HIY "\n$N似乎覺得腹中一陣巨痛，大叫一聲，由于關鍵時刻你的男人沒有守侯在身邊，\n所以$N的孩子流產了，好可憐啊！\n" NOR, me);
                set("qi", 1, me);
                set("jing", 1, me);
                set("neili",query("neili",  me)/2, me);
                set("long",query("longbak",  me), me);
