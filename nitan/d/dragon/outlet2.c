...
"岬囪□２□旱哪廈媯□豢□嘰□奈嗤□鰨□Ω尚鄙歟□礁□盤俅執滯煬鴕\n"
"桓鑾鍇□qiuqian)，一派鄉土氣息。你頓時被這裡的美景迷住了，忘了□n"
"□紡侵恍【□欏□n"
);
        set("exits", ([ 
        ]) );
        ...
        set("item_desc", ([
        "qiu qian": "秋千系用古籐挽就，雖然簡陋，卻別有情趣。你可以試著盪盪(swing)看。\n",
...
int do_swing(string arg )
{
        ...
        switch (random (7)) {
                case 0:
message_vision(HIG"$N爬到秋千上，慢慢地開始盪起秋千，越盪越高。\n"NOR, me);
                break;
                case 1:
message_vision(HIG"秋千越盪越高，$N不由得緊緊抓住古籐。\n"NOR, me);
tell_object(me, "你只覺得風從腳底掠過，人似乎要乘風飛去。\n");
                break;
                case 2:
message_vision(HIG"秋千越盪越高，$N不由得緊緊抓住古籐。\n"NOR, me);
message("vision", me->name()+"似乎看到了什麼東西，匆匆地從秋千上跳了下來。\n", environment(me), me);
  tell_object(me, "你忽然發現前面有什麼發出耀眼的光，光一閃即失。似乎可以往北(beifang)。\n");
                set_temp("marks/marble", 1, me);
                break;
                case 3:
message_vision(HIR"秋千越盪越高，$N一不留神從秋千上掉了下來。\n"NOR, me);
...
tell_object(me, "〝砰！〝你重重地摔在樹根上，屁股好痛哦！ \n");
                ...
                break; 
                case 6:
message_vision(HIR"秋千越盪越高，$N手一滑，從秋千上掉了下來。\n"NOR, me);
tell_object(me, "〝砰！〝你重重地摔在樹根上，屁股好痛哦！ \n");
