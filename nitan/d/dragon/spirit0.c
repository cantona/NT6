...
void create()
{
        set("short", "山谷");
        set("long",
"[1;32m此處有些稀疏的樹木，眼前矗立着一座千層疊翠、萬里點蒼\n"
"的山峯，圍成一處幽谷，中有一泓清潭，泉水從峯間奔流而下，噴珠泄玉，\n"
"直入清潭，還有幾隻小精靈正在潭邊飛舞。此處空氣清涼濕潤，沁人心肺，\n"
...
int do_catch(string arg)
{
   ...
   case 2:
      ...
      break;
   case 3:
      message_vision("$N左撲右擋緊緊地跟着小精靈，深怕一轉眼就不見了……\n", me);
   break;
   case 4:
   ...
   case 6:
      ...
      message_vision("\n小精靈三轉兩轉，倏地一下不見了蹤影。\n\n", me); 
      message("vision", me->name() + "緊緊跟着小精靈倏地一下也不見了蹤影。\n", environment(me), me);
