...
void create()
{
        ...
        set("gender", "男性");
        set("age", 56);
        set("long","這是一個老船夫。飽經風霜的臉上透出一絲狡猾。他經常出海，以前曾經\n去過神龍島。現在他擁有一艘大船可以出海。\n");
...
int chu_hai()
{
        ...
        if( query("party/party_name", ob) == HIY"神龍教"NOR )
        {
