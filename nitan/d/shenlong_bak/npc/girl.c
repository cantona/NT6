...
void create()
{
        ...
        set("chat_chance", 3);
        set("chat_msg", ({
                "少女說道：洪教主身通護佑，眾弟子勇氣百倍，以一當百，以百當萬。\n",
                "少女說道：洪教主神目如電，燭照四方。\n",
                "少女說道：我弟子殺敵護教，洪教主親加提拔，升任聖職。\n",
                "少女說道：我教弟子護教而死，同升天堂。\n",
                "少女高聲叫道：教主寶訓，時刻在心，建功克敵，無事不成！\n",
                "少女忽然齊聲叫道：眾志齊心可成城，威震天下無比倫！\n",
                "少女忽然齊聲叫道：神龍飛天齊仰望，教主聲威蓋八方！\n",
                "少女忽然齊聲叫道：乘風破浪逞英豪，教主如同日月光！\n",
                "少女齊聲叫道：教主永享仙福，壽與天齊！\n",
        }) );
