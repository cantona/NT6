...
void create()
{
        set("short", "洞穴");
        set("long", @LONG
這裏是洞壁高處的一個洞穴，地方小得只能容納一個人存身。這
裏黑洞洞的什麼也看不見，只有洞旁的一株奇異的小草，葉面閃爍着
點點的磷光，顯得鬼魅異常。
LONG );
...
int do_use(string arg)
{
        ...
        if ( arg == "fire" )
        {
                write( HIY "你點燃了火折，可是洞穴裏實在太黑了，一支火折遠不"
                       "夠，看來要找支火把才行。\n\n" NOR);
                return 1;
        }
}
...
int do_insert (string arg)
{
        ...
        message_vision (HIY "$N" HIY "試着將銅牌插入石壁上的小孔中！\n\n" NOR,me);
...
int do_climb(string arg)
{
        ...
        message_vision(HIC "$N" HIC "小心翼翼的攀着巖壁上突出的石筍爬了下去。\n\n" NOR,me);
...
力的痕跡，正中間有一個扁扁的小孔，好像可以插入(insert)什麼東
西試試。
LONG);
