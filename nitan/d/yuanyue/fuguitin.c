...
肉，三四根還沒啃完的肉骨頭，更為惱人的是，只見時不時有幾只老
鼠上躥下跳，整間屋子散發著一種夾雜著濃鬱酒氣的怪味。
LONG );
        set("type","house");
...
/*
        set("item_desc", ([
                "床": "一張偌大的床，又臟又亂，搖搖晃晃的似乎一推就會散架（ｍｏｖｅ）。\n",
                "bed": "一張偌大的床，又臟又亂，搖搖晃晃的似乎一推就會散架（ｍｏｖｅ）。\n",
                "偌大的床": "一張偌大的床，又臟又亂，搖搖晃晃的似乎一推就會散架（ｍｏｖｅ）。\n"
        ]) );
*/
        set("coor/x",-590);
        set("coor/y",220);
...
int do_move(string arg)
{
        ...
        if( query("amount") > 5 )
                return 0;
        message_vision("$N晃了下床，一只小老鼠飛塊地躥了出來．\n", this_player());
