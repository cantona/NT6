...
void create()
{
	...
	if( clonep() )
		...
		set("long", "這是一塊石壁，表面光亮如鏡，刻著寫揮舞著刀法的小人. \n");
		set("unit", "塊");
		set("no_get",1);
		set("value",1000);
		set("material", "stone");
...
int can_xiu( string arg )
{
    ...
    tell_object( me, WHT"你對著石壁，潛心的研究起來。\n"NOR);
...
void start_canxiu( object me )
{
    ...
    if( me->query_xiuwei_by_type("blade") < 5300 )
    {
        ...
        tell_object( me, YEL"你莫名其妙看著石壁上那些招式，只覺心裡空盪盪的。\n"NOR);
        return;
    }
    ...
    tell_object( me, WHT"你慢慢的比劃著那牆上的小人兒圖形，心中突然靈光一閃\n"
                    WHT"你沉思其中，久久不醒......\n"NOR);
