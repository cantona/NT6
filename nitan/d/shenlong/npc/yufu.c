...
void create()
{
	...
	set("inquiry", ([
                //"蛇精" : (: ask_shejing :),
		"阿鼻道第三刀" : "如果你能證明你參與過對抗蛇精之戰，這第三刀的祕密我便告訴你。\n",
	]));
...
mixed ask_shejing()
{
	...
	msg = ({
		"漁夫打量了一下你説道：這位" + ME + "恐怕是剛來這神龍島的吧，呵呵~~",
		"你説道：正是！",
		"漁夫點了點頭又道：老朽是這島附近的一個漁夫，在這附近打漁已經40多年了，還從未見過這蛇精呢。",
		"你疑惑到：哦？那" + YOU + "剛才口中所説的蛇精是怎麼回事？難道這島上真有蛇精不成？",
		"漁夫道：聽祖輩們説過，這島原不叫神龍島，而叫蛇島，這島上有着成千上萬種怪蛇，這些蛇兇猛無比，任何踏足\n"
		"島上的人它們都會主動攻擊，據説，進入蛇島深處的人至今還無一人生還　……",
		"你説道：既然如此，那為什麼那些人又要上蛇島呢，難道這島上有寶貝不成？",
		"漁夫搖了搖頭道：" + ME + "有所不知：這蛇島地處交通要地，凡是出去捕漁的漁夫都會經過此地，每逢遇到風浪，附近\n"
		"捕漁的漁夫都會上島躲避風浪，但是，一旦踏足這蛇島就再無人生還，哎～",
		"你説道：那為什麼附近的漁民不自己組織一批身強力壯之士來將這些蛇全部殺掉，這不就可以永絕後患了嗎？",
		"漁夫歎了口氣道：聽我的祖輩們説，他們先後組織了四批勇士前來島上，這四批勇士每個都是身懷絕跡，並且都帶着\n"
		"火把、硫磺，裝備着各種兵器、鎧甲，起初進入蛇島，一切都還順利，將蛇殺得幾乎一條不留，但是到後來……",
		"你急切道：後來，後來怎麼了？難道是？",
		"漁夫點了點頭繼續道：但是後來，他們卻發現這島上的射就猶如江河水一般，源源不斷，始終殺不完，而且越殺越多，\n"
		"到最後這些勇士一個個都是耗盡精力被羣射纏食而死。",
		"你迫不及待地追問道：這難道是蛇精在作祟？",
		"漁夫稍有懼色道：蛇精，蛇精！誰有沒見過，當時這四批公認最厲害的勇士全軍覆沒後，也再沒人敢提這件事了，從此附近\n"
		"漁民外出捕漁都是繞過此島，即使是遇到風浪也不再踏足此島。後來，這事就漸漸被人遺忘。",
		"你説道：那後來呢？沒人見過蛇精怎麼會有人知道是蛇精在作祟呢？",
		"後來有一位遊方道人到此小住，見漁民出外捕漁都是避蛇島而遠之，便覺奇怪，後來多放打探才知道原委。這位道人為報答\n"
		"漁民盛情，事後，開壇做法，欲除去這島上之害，但是，這位道人道行有限，一系列法事後，他告訴附近村民説，經他開壇\n"
		"做法雖不能解除蛇島之患，但他算出這蛇島上的毒蛇並非原本就有，而是來自與這蛇島上的千年蛇精，只要這隻蛇精不\n"
		"除，蛇島之患便永久無法解除。",
		"你連忙問道：那這位道人有沒有説怎麼才能殺掉這兩隻蛇精呢？",
		"漁夫搖頭道：這我就不是很清楚了，剛才我所説的也是聽我父輩口述，只知道後來蛇精被壓在這蛇島底，這島也改名叫神龍島，\n"
		"至於其中來龍去脈我就不得而知了，但是，據説，最後有一位叫賽神龍的勇士降伏了蛇精",
		"你説道：哦？賽神龍，何許人也？",
		"漁夫道：我聽我祖輩説，賽神龍乃人中龍鳳，武藝超羣，當年，由他帶頭降伏了蛇精，並終身駐守神龍島，以防蛇精重出人間。",
		"你説道：那怎麼才能找到賽神龍？",
		"漁夫道：聽説他就駐守在此島的蛇精洞內，但是，千百年來也無人再敢進入 ……",
		"你説道：多謝！",
...
int accept_object(object me, object ob)
{
	...
	{
		command("say 這不是從九頭蛇精身上掉下鱗片嗎！閣下勇氣超羣，老夫佩服，佩服！");
		command("tan");
