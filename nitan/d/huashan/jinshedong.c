...
void create()
{
        ...
        msg = "只見對面石壁上斜倚著一副骷髏骨，身上衣服已爛了七八成，那骷髏\n"
              "骨宛然尚可見到是個人形。你見到這副情形，一顆心□□亂跳，見石室中\n"
              "別無其他可怖事物，于走近仔細照看。石壁上有幾百幅用利器刻成的簡陋\n"
...
骷髏骨宛然尚可見到是個人形。你見到這副情形，一顆心□□亂跳，
見石室中別無其他可怖事物，于走近仔細照看。石壁上有幾百幅用利
...
LONG );
        ...
        set("item_desc", ([
              "ya"    : NOR + WHT "懸崖下峭壁高聳，一條青籐（teng）直垂而下。\n" NOR,
              "teng"  : HIG "一根青籐，在半空中搖晃著，可以用他爬（climb）上懸崖。\n" NOR,
              "sword" : (: look_sword :),
        ]));        
...
int do_ba(string arg)
{
        ...
        show = "只見對面石壁上斜倚著一副骷髏骨，身上衣服已爛了七八成，那骷髏\n"
              "骨宛然尚可見到是個人形。他見到這副情形，一顆心□□亂跳，見石室中\n"
              "別無其他可怖事物，于走近仔細照看。石壁上有幾百幅用利器刻成的簡陋\n"
...
int do_climb(string arg)
{
        ...
        message_vision(HIG "$N" HIG "拉著青籐爬上懸崖……\n", me);
