...
自來相傳是玉女發釵上的一顆珍珠，當年華山派的祖師以此危崖為懲
...
{  
        ...
        if( arg == "風清揚" && !query_temp("marks/風", me) && random(30) == 5 )
        {
                ...
                message_vision("$N回過頭來，見山洞口站著一個白須青袍老者，神氣抑鬱，臉如金紙。\n", me);
                ...
                {      
                        ...
                        write( "寂寂。最終與一神雕歸隱，埋劍「劍塚」。嗚呼！群雄束手，長劍空\n");
                        write( "利，不亦悲夫！據聞「劍塚」的所在地是位于襄陽城外附近，心存誠\n");
                        write( "意，入口自現。至于到底如何心存誠意，則非我所知。希望你能尋得\n");
                        write( "寶劍，造福武林。\n");
                        write( "風清揚說罷，便飄然下山。\n");
                }
                else 
