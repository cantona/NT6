...
mixed ask_zhiliao()
{
        ...
        msg+= HIY "老村長默念口訣，然後用手在你身上一點，頓時一到金光將你籠罩 ……\n" NOR;
...
"----------------------------------------------------\n" HIY +
"    文字MUD遊戲是懸浮于現實中的一個虛擬世界，" HIM "在這裡你可以扮演一個角色，\n"
"這個角色也許就是你在現實中隱藏于內心深處的真實性格的折射。 你可以控制\n"
"你所扮演的角色在這個虛擬的世界裡生存、成長、尋覓、宣泄 ……，你也將逐\n"
...
"藝，鑽研至高無尚的武學；你也可以無憂無慮做些買賣， 四處搜羅一些奇珍異\n"
"寶賣個好價錢，成為一名富甲天下富豪；當然， 你也可以整日摸索諸如機關鑄\n"
"造之術，鍛造出震驚天下的神兵利器，戰衣寶甲； 如果你是懷著一顆救世濟民\n"
"之心，你也可以立志做一名藥師， 將畢生的精力灌注于對醫術、藥理的研究中，\n"
...
"    泥潭是一個以濃鬱的武俠色彩為背景的虛擬文字網絡遊戲，" HIM "注冊進入遊戲後\n"
"你首先來到的是『" HIG "古村" HIM "』，在這裡，你將在系統為你設定的新手導師的細心的指\n"
"導下，了解和掌握如何進行這個遊戲。同時，在你向新手導師學習的過程中你可\n"
"以通過完成一些新手導師交給你的簡單任務獲取一定的經驗點和相關獎勵，更重\n"
"要的是，在古村的「武伯」（在練武場）處你還可以學到幾種武功技能，這將對\n"
"你日後的發展和行走江湖有很大的幫助。\n\n" HIY + 
"    當在古村歷練完或不願歷練，你可請求導師「老村長」允許你出村，" HIM "一旦老\n"
"村長覺得你歷練合格後將準許你離開古村進入江湖闖盪。大家注意了，在古村裡\n"
"一切都有導師老村長的照顧，生病啊、受傷啊、饑餓啊什麼都可以免費找他，而\n"
"且在古村裡你的年齡永遠不會增加。但是一旦你出了古村，進入紛亂復雜的江湖\n"
"就大不一樣了，一切都得自己照顧自己了。\n\n" HIY +
...
"    具體的細節可通過 " HIY "ask lao about 信息編號" HIM " 來進一步了解。\n\n" HIM
...
"過你是以另一個虛擬的角色存在于這個世界中。你可以在這裡完成你在現實中無\n"
"法完成的想法、願望或者一些夢想 ……\n\n"
...
"                                                     泥潭巫師組 歡迎您\n\n" NOR;
        ...
        {                 msg = HIW + "\n"
"老村長對你說道：那就讓我來告訴你關于泥潭職業的相關信息吧：\n"
"----------------------------------------------------\n" HIM +
"    抱歉，目前職業系統更新中，暫未開放。\n\n" NOR;
        } else
        if (topic == "9") // 如何生存
        {
                msg =  HIM "關于<如何生存>有以下相關信息：\n" NOR;
                msg += HIY "編號         信    息\n" NOR;
                msg += HIY "------------------------------------------\n" NOR;
                msg += HIC "91        解決溫飽\n"
                           "92        生病了怎麼辦\n"
        ...
        if (topic == "42") // 查看我自己的基本資料
        {
                ...
                msg += HIM "關于<score指令所顯示的基本資料>有以下相關信息：\n" NOR;
                msg += HIY "編號         信    息\n" NOR;
                msg += HIY "------------------------------------------\n" NOR;
                msg += HIC "421       天性的作用\n"
                           "422       實戰經驗的作用\n"
        ...
        if (topic == "44") // 查看我自己的天賦屬性
        {
                ...
                msg += HIM "關于<hp -g 指令所顯示的數據>有以下相關信息：\n" NOR;
                msg += HIY "編號         信    息\n" NOR;
                msg += HIY "------------------------------------------\n" NOR;
                msg += HIC "441       臂力的作用\n"
                           "442       悟性的作用\n"
...
"險姦詐之輩。除了武功對性格的要求外，不同性格同時還具有以下特\n"
"點：\n\n" HIY +
...
"時候需要消耗精氣。精氣為零只會導致你不能讀書或研究武功，不會\n"
"暈倒。\n\n" HIR
"   如何提高精氣？\n\n" HIM 
...
"    rumor <聊天內容>  ： 發布謠言。此頻道可隱藏發言人的姓名。\n"
"    bill <聊天內容>   ： 交易頻道，交易信息可在此頻道發布。\n"
...
"-----------------------------------------------------\n" HIM +
"    一個人總有饑餓和口渴的時候，這時，就需要補充以下能量了，通常在各城市的客\n"
"店裡能買到雞腿和水袋等。使用指令 eat <物品ID> 可吃東西，而指令 drink <物品ID>\n"
"可以喝水等物品。\n\n"
"    在古村裡，你不會饑餓或者口渴，但是一旦你出去了就需要注意了。\n\n" NOR;
        } else
        if (topic == "92") // 生病了怎麼辦
        {
                msg = HIW + "\n"
...
"--------------------------------------------------------\n" HIM +
"    通常新手由于體質較差會經常生病，這時，新手可以到揚州的藥舖裡有各種治病的\n"
...
"-------------------------------------------------------\n" HIM +
"    如果你內功等級高，你中毒後，可以先封閉穴道（輸入指令 fengxue），然後盡快\n"
...
"的戰鬥效果，如桃花島絕學「陰陽八卦」，可以破除對手的特殊防御效果；其他部分雖然不\n"
...
"-----------------------------------------------------------------------\n" HIM +
"    每個人要成長總得不斷地學習，拜師是個人成長發展的必然階段，泥潭提供了30余個門派供\n"
...
"功稍稍有點不同，試想，雖然空手武功也需要激發，但是，由于空手武功包含了：拳腳、掌法、\n"
...
"    bei claw，這樣就完成了空手技能的準備。現在，裝上你心愛的兵器，出去闖盪江湖吧！！！\n\n" NOR;
...
"    perform 絕招ID\n\n" NOR;
        ...
        {
                msg += HIM "    現在，你將接受一個練習，到竹林使用天劍的絕招（perform lian）殺一只\n" NOR;
                ...
                me->set("newbie_quest/msg",HIY"你先用天劍的絕招（perform lian）到竹林殺（kill ye tu）一只野兔，然後\n"
...
"-------------------------------------------------------------\n" HIM +
"    除了與導師在線交流及短消息溝通外，一些問題你需要征求所有導師的意見以及本站管\n"
"理巫師的意見，你可以使用 teach help 指令發布你的求教信息。\n\n" NOR;
        }  else
...
mixed ask_here()
{
        ...
        msg += HIY "如果你是位老玩家，你也可以直接ask lao about 出村，去闖盪江湖，當然這樣的話你可能會錯失了某種機緣。\n" NOR;
...
mixed ask_chucun()
{
        ...
        */
        ...
        msg = HIY "不錯，不錯，看來你已經決定出去闖盪江湖了！在你臨走前，我將送你一件\n"
                  "禮物，你先把你的眼睛閉上（指令 closeeye ）吧。\n\n" NOR;

        if( !query("gift_xinshoucun", me)) tell_object(me,msg);

        else
                tell_object(me, HIY "不錯，不錯，看來你已經可以出去闖盪江湖了！\n\n" NOR);
...
int do_closeeye(string arg)
{
        ...
        msg = HIM "你閉上雙目，只感覺有一只熾熱的手按在你天靈蓋上，一股暖暖的真氣緩緩流入你的體內。\n"
        ...
        msg+= HIG "老村長說道：你現在到村口找花伯（指令 ask lao about 出村）吧，他會告訴你怎麼出古村！\n";
