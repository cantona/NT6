...
string inquiry_afeng()
{
 ...
 {  message_vision("阿土又說道：這位"+ RANK_D->query_respect(me)+"，我已經托人幫我帶了，也不知道她的心意如何，唉.....\n",me);
   return "";
 }
   message_vision("阿土又說道：這位"+ RANK_D->query_respect(me)+"，我這裡有封我寫了三天三夜的情書，麻煩你了,我後半生的幸福就托給你了。\n" , me);
   obn=new("/d/shiliang/npc/obj/qingshu");
   obn->move(me);
   set_temp("qingshu",0);
   return "請你一定交到她的手上。說完從懷裡摸出一封折疊成千紙鶴般的信，交給你。\n";
}