...
void  create  ()
{
        set("short",  "關林");
        set("long",  @LONG
此處位于洛陽城南十四裡處。關林始建于唐，相傳為三國蜀將關羽
首級的葬地，前為祠廟，後為墓塚，塚高五丈有余，千株參天翠柏，蔚
然成林，故稱“關林”。明萬歷年間始建廟植鬆。清乾隆時又加擴建，
致成現今的規模。關林總面積約百畝左右，三大殿和鐘鼓樓，紅牆碧瓦，
雕樑畫棟，建築嚴整。大殿塑有關羽著帝王裝像，二殿為戎裝像，東殿
為關羽睡臥像，西殿為秉燭誦《春秋》像，大殿前廊有復制八十三斤重
的青龍偃月刀一把。古柏蒼鬱，殿宇堂皇，隆塚巨碑，上書“忠義神武
關聖大帝”，氣象幽然。
    常有江湖義士來此拜祭。
LONG);
        set("exits",  ([  /*  sizeof()  ==  2  */
...
int do_ketou()
{
        ...
        message_vision(HIG"$N屈膝跪下，一個響頭恭敬地磕了下去。猛然間，一陣狂風刮地而來，只聽“啪”的一聲，鬆枝上掉下一塊腰牌，正落在$N懷裡！也不知道是哪個調皮鬼掛在上面的。\n"NOR, me);
