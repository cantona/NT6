...
void create()
{
        ...
        set("noget", "莊允城歎道：我不行了，你走吧。唉，我擔心我家裏人啊。\n");
        set("chat_chance", 5);
        set("chat_msg", ({
        "\n莊允城説道：只怪我當初好心，在書中夾了金葉送與他，\n"
        "誰想這狼心狗肺的傢伙竟然就去告發了我。唉...\n",
        "\n莊允城説道：誰要把吳之榮抓到莊府就好了。\n",
        "莊允城突然説道: 江湖威望很重要，威望高大有好處啊。\n",
        "\n莊允城歎了口氣，説道：我知道鰲拜書房的祕密，只可惜我出不去啊。\n",
        "莊允城説道：誰要救了我，我一定把我知道的都告訴他。\n",
        }));
        set("inquiry", ([
                "吳之榮" :  "把他送到莊府去有好處。",
                "威望" :  (: ask_weiwang :),
...
say("\n莊允城説：如果你威望值很高，有些人見了你不但不會殺你，還會教你武功，送你寶貝。\n"
+"而且你還可以加入幫會，率領會眾去攻打目標，就連去錢莊取錢也會有利息 。。。。。\n");
say("莊允城又説：殺某些壞人或救某些好人可以提高江湖威望。\n");
return 1;
}
...
int accept_object(object me, object ob)
{
        ...
        if( query("name", ob) == "明史輯略" )
        {
         ...
         write(HIC "莊允城説：替我把吳之榮這廝抓到莊府去吧，我不行了。\n" NOR);                
         write("莊允城喘了口氣，又説：莊府在京城東北邊。\n");
        }                
        return 1;
}
