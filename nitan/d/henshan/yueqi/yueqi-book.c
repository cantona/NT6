...
"和歌的常用樂器。隋唐時期用于清樂。以後則只用于宮廷雅\n"
"樂和丁祭音樂 \n\n"
"   排簫：吹奏樂器。又名洞簫、雅簫、頌簫 鳳簫、雲簫等。\n"
"早在原始社會，已有用蘆葦編制成的葦龠。排簫管數、長度，\n"
"歷代記載不同，而且形制、大小有別。唐代以前，排簫逕稱\n"
"簫。唐宋以後，由于單管豎吹的簫日漸流行，便稱編管簫為\n"
"排簫，以示區別。元明兩代，排簫改進為精致的□簫。清代\n"
"排簫為雙翼形制的□簫。\n\n"
"   鐘：古代打擊樂器。鐘在古代“八音”分類法中屬金部。\n"
"鐘盛行于青銅時代。鐘在古代不僅是樂器，還是地位和權力\n"
"象征的禮器。王公貴族在朝聘、祭祀等各種儀典、宴饗與日\n"
"常燕樂中，廣泛使用著鐘樂。敲擊鐘的正鼓部和側鼓部可發\n"
"兩個頻率音，這兩個音，一般為大小三度音程。由于青銅鐘\n"
"質料堅實和耐腐蝕，數千年來，給我們留下了古代真實的音\n"
"響、 留下了豐富的古鐘遺產，它們不分朝代地並存于今世，\n"
"集歷代政治、歷史、音樂、民俗、冶煉、宗教等各種文化\n"
"內涵于一身，形成奇特的中華古鐘文化。\n\n"
"   磬： 質料主要是石灰石，其次是青石和玉石。均上作倨\n"
"句形，下作微弧形。大小厚薄各異。磬架用銅鑄成，呈單面\n"
"雙層結構，橫樑為圓管狀。立柱和底座作怪獸狀，龍頭、鶴\n"
"頸、鳥身、鱉足。造型奇特，制作精美而牢固。磬分上下兩\n"
"層懸掛，每層又分為兩組，一組為六件，以四、五度關系排\n"
"列；一組為十件，相鄰兩磬為二、三、四度關系。它們是按\n"
"不同的律（調）組合的。\n\n"
