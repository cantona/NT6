...
void greeting(object ob)
{
        ...
        {
message_vision("祭祀喇嘛急急忙忙吩咐小喇嘛們往祭壇裡填柴，倒酥油。\n\n", ob);
...
int accept_object(object who, object ob)
{
        ...
        {
message_vision("祭祀喇嘛笑著對$N說：這種臭東西給我有什麼用，您還是自己留著吧！\n", who);
                return 0 ;
        }
        if( query("killed_by", ob) != query("id", who) )
{
               message_vision("祭祀喇嘛嚴厲的對$N說：不是自己殺的還來超度?\n", who);
           return 0;
}

        if( query("name", ob) == "無頭屍體" )
{
               message_vision("祭祀喇嘛嚴厲的對$N說：腦袋沒有了還怎麼超度！\n", who);
           return 0;
}
        delete_temp("法事", who);
        ...
        {
                message_vision("祭祀喇嘛笑著對$N說：那我們去祭壇吧！\n", who);
...
//                destruct(ob);
                ...
                return 1;
                 ...
                 message_vision("祭祀喇嘛對$N說：這種東西還能做法事？直接埋了省事。\n", who);
        return 0;
}
