...
int ask_wumu()
{
command("say 嶽武穆名飛字鵬舉，乃抗金的名將，一生用兵如神。據説他死後留下了一部\n"
"武穆遺書，其中記載着他一生戎馬生涯的兵法要訣。\n");
return 1;
}

int ask_yishu()
{
command("say 這部遺書最早收藏在皇宮之中，後聽説鐵掌幫幫主上官劍南率幫中高手，將\n"
"此書偷走，不知是真是假。\n");
return 1;
}
...
command("say 看來" + RANK_D->query_respect(ob) + "也是我輩中人，老朽這裏有一幅字帖送給你，希望你\n"
"能不忘驅除胡虜，還我河山的志向！");
zitie->move(ob);
