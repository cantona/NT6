...
void create()
{
    set("short", HIR "無名峯" NOR);
        set("long", @LONG
跨過路上的荊棘和荒草，你終於登上了五指山無名峯的峯頂。由於這裏
地處五峯之中，四周有其它山峯阻擋，因此風勢很小，常年籠罩在一片雲霧
之中。峯頂長滿了齊腰的荒草，怪石嶙峋，一片荒涼景色。在山峯頂部的正
中赫然矗立着一座巖石砌就的墳墓，墳墓的前面立着一塊一人多高的花崗巖
的墓碑(bei)。
LONG    );
        set("exits", ([
