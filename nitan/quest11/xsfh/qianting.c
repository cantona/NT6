...
void init()
{
     ...
     &&!me->query_temp(QUESTDIR2+"kill"))
  {
     ...
     message_vision(HIR"\n$N飄然落地，只見前廳裏站着三個黑衣人，聽到一個黑衣人喊道：並肩一起上。\n"NOR, me);
...
void killme(object me)
{
     ...
     &&!me->query_temp(QUESTDIR2+"kill"))
  {
     ...
     obj->set("kill_id",me->query("id"));
     obj->move(environment(me));
     tell_object(me,HIG"\n\n哪裏來的三個好手，只是行事為何如此卑鄙。不知道苗大俠傷勢如何，當務之急還是儘快解決眼前敵人。\n"NOR);
     message_vision(HIC"$N聽到兵刃劈風之聲襲向頭頂，中間夾着鎖鏈扭動的聲音，知是三節棍、鏈子槍一類武器，$N右手倏地伸出，抓住那$n的三節棍的棍頭一抖。\n"NOR, me,obj);
     message_vision(HIC"那$n“啊”的一聲，手臂痠麻，三節棍已然脱手，$N順手揮出，拍的一響，擊在$p腰眼之上。$n立時閉氣，暈了過去。\n\n"NOR, me,obj);
     obj->unconcious();
  }
}
