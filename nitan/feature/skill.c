...
varargs void map_skill(string skill, string mapped_to)
{
        if( !mapped_to && mapp(skill_map) ) {
                ...
                SKILLS_D->check_skill_mix(this_object(), 1);
        ...
        SKILLS_D->check_skill_mix(this_object(), 2);
}
...
int skill_death_penalty()
{
        ...
        //skill_map = 0;
        //skill_prepare = 0;
        SKILLS_D->check_skill_mix(this_object(), 0);
