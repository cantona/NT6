...
if (damage > 0)
{
        switch(me->query("wuxing/mofa"))
        {
                case 0:
                        if (ob->query("wuxing/mofa") == 8)
                        {
                                if (random(9) > 4)
                                {
                                        ...
                                        message_vision(NOR"\n$N的光明力量和$n的黑暗力量以一種極不穩定的形態相互沖撞激盪.....\n"HIW"突然$N身上強光一閃，$N的光明力量似乎擺脫了$n的黑暗力量的束縛在$N身前形成一道光之屏障。\n"NOR,me,ob );
                                        tell_object(me, HIM"你的光明力量額外防御了"+damage*2/5+"點傷害。\n"NOR);
                                }
                                else
                                {
                        ...
                        else
                        {
                                if (random(9) > 4)
                                {
                                        ...
                                        tell_object(me, HIM"你的光明力量額外防御了"+damage*1/5+"點傷害。\n"NOR);
                                }
                                else
                                {
                                        damage_magic = damage;
                ...
                case 1:
                        if (random(9) > 4)
                        {
                                if (ob->query("wuxing/mofa") == 2)
                                {
                                        ...
                                        tell_object(me, HIM"你的地之力量額外防御了"+damage*2/5+"點傷害。\n"NOR);
                                }
                                ...
                                else
                                {
                                        ...
                                        tell_object(me, HIM"你的地之力量額外防御了"+damage*1/5+"點傷害。\n"NOR);
                                }
                        }
                        else
                                damage_magic = damage;
                ...
                case 2:
                        if (random(9) > 4)
                        {
                                if (ob->query("wuxing/mofa") == 4)
                                {
                                        ...
                                        tell_object(me, HIM"你的火之力量額外防御了"+damage*2/5+"點傷害。\n"NOR);
                                }
                                ...
                                else
                                {
                                        ...
                                        tell_object(me, HIM"你的火之力量額外防御了"+damage*1/5+"點傷害。\n"NOR);
                                }
                        }
                        else
                                damage_magic = damage;
                ...
                case 3:
                        if (random(9) > 4)
                        {
                                if (ob->query("wuxing/mofa") == 10)
                                {
                                        ...
                                        tell_object(me, HIM"你的水之力量額外防御了"+damage*2/5+"點傷害。\n"NOR);
                                }
                                ...
                                else
                                {
                                        ...
                                        tell_object(me, HIM"你的水之力量額外防御了"+damage*1/5+"點傷害。\n"NOR);
                                }
                        }
                        else
                                damage_magic = damage;
                ...
                case 4:
                        if (random(9) > 4)
                        {
                                if (ob->query("wuxing/mofa") == 1)
                                {
                                        ...
                                        tell_object(me, HIM"你的木之力量額外防御了"+damage*2/5+"點傷害。\n"NOR);
                                }
                                ...
                                else
                                {
                                        ...
                                        tell_object(me, HIM"你的木之力量額外防御了"+damage*1/5+"點傷害。\n"NOR);
                                }
                        }
                        else
                                damage_magic = damage;
                ...
                case 5:
                        ...
                        {
                                damage_magic = damage*4/5;
                                message_vision(NOR"\n$N的身影突然變得朦朧，一道旋風憑空卷起護在$N周圍。\n"NOR,me);
                                tell_object(me, HIM"你的氣之力量額外防御了"+damage*1/5+"點傷害。\n"NOR);
                        }
                        else
                                damage_magic = damage;
                        break;
                ...
                case 6:
                        if (random(9) > 4)
                        {
                                ...
                                tell_object(me, HIM"你的雷之力量額外防御了"+damage*1/5+"點傷害。\n"NOR);
                        }
                        else
                                damage_magic = damage;
                        break;
                ...
                case 7:
                        if (random(9) > 4)
                        {
                                ...
                                tell_object(me, HIM"你的心靈力量額外防御了"+damage*1/5+"點傷害。\n"NOR);
                        }
                        else
                                damage_magic = damage;
                        break;
                ...
                case 8:
                        if (ob->query("wuxing/mofa") == 0)
                        {
                                ...
                                {
                                        damage_magic = damage*3/5;
                                        message_vision(NOR"\n$N的黑暗力量和$n的光明力量以一種極不穩定的形態相互沖撞激盪.....\n突然$N身上黑暗氣息大盛，$N的黑暗力量沖破了$n光明力量的約束在$N周圍形成一道黑暗天幕。\n"NOR,me,ob );
                                        tell_object(me, HIM"你的黑暗力量額外防御了"+damage*2/5+"點傷害。\n"NOR);
                                }
                                else
                                {
                                        damage_magic = damage*7/5;
                        ...
                        else
                        {
                                if (random(9) > 4)
                                {
                                        ...
                                        tell_object(me, HIM"你的黑暗力量額外防御了"+damage*1/5+"點傷害。\n"NOR);
                                }
                                else
                                {
                                        damage_magic = damage;
                ...
                case 9:
                        if (random(9) > 4)
                        {
                                ...
                                tell_object(me, HIM"你的空間力量額外防御了"+damage*1/5+"點傷害。\n"NOR);
                        }
                        else
                                damage_magic = damage;
                        break;
                ...
                case 10:
                        if (random(9) > 4)
                        {
                                if (ob->query("wuxing/mofa") == 1)
                                {
                                        ...
                                        tell_object(me, HIM"你的金之力量額外防御了"+damage*2/5+"點傷害。\n"NOR);
                                }
                                else if (ob->query("wuxing/mofa") == 2)
                                {
                                        damage_magic = damage*7/5;
                                        message_vision(HIR"\n$n身上紅光一閃，一道火燄憑空出現徑直卷向$N。\n"NOR,me,ob);
                                ...
                                else
                                {
                                        ...
                                        tell_object(me, HIM"你的金之力量額外防御了"+damage*1/5+"點傷害。\n"NOR);
                                }
                        }
                        else
                                damage_magic = damage;
