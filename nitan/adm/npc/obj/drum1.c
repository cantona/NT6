                ...
                if (query("loop"))
                {
                        ...
                        if (stringp(query("drum_knocked")))
                        {
                                ...
                                if (no1)
                                {
                                        ...
                                        HISTORY_D->add_history("華山論劍", query("id", no1), sprintf("新鋭組 %s(%s)，年齡 %d、等級 %d，榮獲名次 1.\n", 
                                ...
                                if (no2)
                                {
                                        ...
                                        HISTORY_D->add_history("華山論劍", query("id", no2), sprintf("新鋭組 %s(%s)，年齡 %d、等級 %d，榮獲名次 2.\n", 
                                ...
                                if (no3)
                                {
                                        ...
                                        HISTORY_D->add_history("華山論劍", query("id", no3), sprintf("新鋭組 %s(%s)，年齡 %d、等級 %d，榮獲名次 3.\n", 
...
void checking(object ob1, object ob2)
{
        ...
        if (winner)
        {
                ...
                message_vision(HIC "$N哈哈大笑，從擂台上跳了下來。\n" NOR, winner);
