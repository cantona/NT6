...
string *quest_msg = ({
        ...
        HIW "北醜説道：聚賢莊這個名字，你應該不會陌生吧。\n" NOR,
        HIW "前些時候，遊氏兄弟和薛神醫在江湖上廣發英雄帖，召集天下英雄豪傑共赴聚賢莊，參加武林大會。\n" NOR,
        HIW "這張帖子是給你的，但是你向來四海為家，居無定所，聚賢莊發派帖子的下人就把你的英雄貼送到我這裏來了，希望我可以找到你。\n" NOR,
        HIW "至於這次武林大會究竟是為何事，老朽我也不是很清楚，只聽説和丐幫有莫大的關係，江湖上的風言耳語，傳來傳去的，可以相信的已經不多了。\n" NOR,
...
LONG);
        ...
        set("chat_chance", 1);
        set("chat_msg",({
                CYN "北醜賊眯眯的説：天算地算不如人算，可是再怎麼算戲子我都知道。\n" NOR,
        }));
