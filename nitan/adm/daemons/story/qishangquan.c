...
nosave mixed *story = ({
        ...
        "張無忌：楊左使説得也沒錯，那麼我就和楊左使先回光明頂，義父你和韋一笑去追擊成昆吧。",
        "韋一笑：是，教主。",
        "謝遜：無忌，不必啦，光明頂重整需要人手，成昆我一個人去殺他就夠，韋一笑還是和你一起回明教吧。",
        "張無忌：也好！義父，那我們先走了。",
        "説罷，張無忌、楊逍、韋一笑等三人就轉身回明教去了。",
        "謝遜心想：雖然説我的武功足以殺成昆，但是......應該也會有一場惡戰！！不想了，追上去再説。",
        "不出半個時辰，謝遜已經追到了成昆.........",
        "謝遜喝道：成昆，你別想再跑！",
        "成昆嚇得出了一身冷汗，過了一會才慢慢的轉過身來，一見到只有謝遜一人才鬆了一口氣。",
        "成昆：我説我的徒兒，憑你也想殺你的師父麼？雖説你的功夫有很大的進步，但是我這幾年也不是白活啊！",
        "謝遜：廢話少説，來吧！！！",
        "謝遜説罷就向成昆揮出一拳，成昆嘿嘿一笑，身體輕輕一轉就避開了。",
        "謝遜心想：以現在的情況要殺死成昆確實不易，如果那天在光明頂答應幫我殺成昆的$N在這裏的話，那就一定沒問題",
        "話説曹操，曹操就到，$N路過這裏一見謝遜和成昆正打得火熱，就馬上施展輕功趕到謝遜身邊。",
        "$N對着謝遜説道：謝老前輩，今天可以實現我的諾言了！",
        "成昆望着$N在那裏噁心的表演心中有説不出的煩，鄙視的望着$N“呸”的一聲！",
        ...
        "謝遜對天狂笑：哈哈哈！哈哈哈哈！！！哈哈！！！！！！",
        "過了良久......",
        "謝遜對着$N説到：我現在就按照當天的約定，把我的七傷拳傳授給你！",
        (: give_gift :),
});
...
int give_gift()
{
        ...
        tell_object(ob, HIC "你從謝遜那裏學習到了七傷拳。\n" NOR);
