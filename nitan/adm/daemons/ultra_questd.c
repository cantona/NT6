...
public mixed accept_ask(object me, object who, string topic)
{
        ...
        if (topic == "任務" || topic == "quest")
        {
                ...
                if (! ultrap(who))
                {
                        message_vision("$N瞪大眼睛看着$n，道：“你還沒有成為武學大宗師，還幫不了"
                                       "我什麼忙！”\n", me, who);
                        return 1;
                }
                ...
                {
                        message_vision(CYN "$N" CYN "歎了一口氣，對$n" CYN "道：你這人閲歷太低，"
                                       "不通世道，幫不了我什麼忙。\n" NOR, me, who);
                        return 1;
                }
                ...
                */
                ...
                case 2:
                        type = "kill";
                        message_sort(CYN "$N" CYN "對$n" CYN "道：聽説有一股勢力正在策劃在"
        ...
        if (topic == "取消" || topic == "cancel")
        {
                ...
                */
                ...
                message_vision(CYN "$N" CYN "歎口氣，看了看$n" CYN "道：連這點小事都幹不了？算了吧。\n" NOR,
                               me, who);
                tell_object(who, HIR "你的江湖威望和江湖閲歷受到了損失。\n" NOR);
                return 1;
        }
        ...
        */
        ...
        case 2 :
                ...
                msg = random(2) ? "你幫我把這個包裹送到" HIY +
                                  next_name + "(" + next_id + ")" + NOR + WHT "那裏，看看他"
                                  "有什麼反應。\n聽説他最近在" + place + "，你快去吧！":
        ...
        tell_object(who, WHT + me->name() + WHT "悄悄對你説道：" +
                        msg + "。\n" NOR);
...
public void quest_guard(object me, object who)
{
        ...
        set("ultraquest/quest/name",query("name",  me), who);
        set("ultraquest/quest/id",query("id",  me), who);
        set("ultraquest/quest/msg", "留在這裏保護我", who);
...
int accept_object(object me, object who, object ob)
{
        ...
        if( query("name", me) == QUESTER )
        {
                ...
                if (ultra_count == 10)
                {
                        msg += CYN "$N" CYN "哈哈大笑兩聲道：“真有你的，連着上十"
                               "次任務都完成的漂漂亮亮，很好，很好。”\n" NOR;
                        special = 1;
                } else
                if (ultra_count == 25)
                ...
                if (ultra_count == 50)
                {
                        msg += CYN "$N" CYN "歎道：“真是長江後浪推前浪，想不到你接連五十"
                               "次任務都無一疏漏，不易，不易！”\n" NOR;
                        special = "/clone/gift/tianxiang";
                } else
                if (ultra_count >= 100)
                {
                        msg += CYN "$N" CYN "深深歎了口氣，道：“想不到你連着上百次"
...
public void generate_information(object me, object who)
{
        ...
        if( query("ultraquest/finish", who) == 5 )
        {
                ...
                case "kill":
                        ...
                        tell_object(who, CYN + me->name() + CYN "小聲對你説道："
        ...
        {
        case 1:
                msg = "聽説，這個幕後黑手曾遺失過一個重要物品，通過這個物品可以知"
                      "道他是誰。\n好像" + place + "的" + next_name + "就知道這"
                      "個物品的下落。\n" + ma + "可去找他問問，但也不知是真是假";
                break;

        case 2:
                msg = "那物品我到是聽説點線索，" + ma + "知道" + place + "嗎？\n"
                      "那裏有個" + next_name + "，傳聞你要找的那東西就在他身上";
                break;
        ...
        // 提供出任務的描述信息
        msg = WHT + me->name() + WHT "悄悄對你説道：" + msg + "。\n" NOR;
