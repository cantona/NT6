...
string *longs=({
    "這是一個精靈族的小商販，出售各式的物品。\n你可以問他關于「"+quests[0]+"」的事情。\n",
    "這是一個精靈族的小女孩子，不知道為什麼看起來一副神色著急的模樣。\n你可以問她關于「"+quests[1]+"」的事情。\n",
    "這是一個白發蒼蒼的老人，但卻神採奕奕地十分強健的樣子。\n你可以問他關于「"+quests[2]+"」的事情。\n",
    "這是一個白發蒼蒼的老人，神採飛揚，看似所知十分淵博的樣子。\n你可以問他關于「"+quests[3]+"」的事情。\n",
    "這是一個精靈族的小商販，出售各式的物品。\n你可以問他關于「"+quests[4]+"」的事情。\n",
    "這是一個大方瀟洒的中年人，腰間配著一柄長劍。\n你可以問他關于「"+quests[5]+"」的事情。\n",
    "這是一個神態猥瑣的中年人，矮矮胖胖的一副狡詐模樣。\n你可以問他關于「"+quests[6]+"」的事情。\n",
    "這是一個精靈族的小女孩子，不知道為什麼看起來一副神色著急的模樣。\n你可以問她關于「"+quests[7]+"」的事情。\n",
...
string *ChatMsg=({
    ...
    "摸了摸胡子，笑道：“爾等雖身在其中，但這俠義世界之事，卻又知曉幾分？”\n",
    "嘿嘿笑道：“我這裡有一些好東西賣，誰要來買一點？”\n",
...
// 若是這兩位，有特別的操作
// 藏劍生，產生有標記的劍 n 把，放于隨機地點內。這 n 把劍是同樣名字的，
// 拿到任意一把，都能夠完成這個 JOB。
