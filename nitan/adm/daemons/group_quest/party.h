...
({
        ...
        "幾把鋼刀當面劈將過來...",
        "name1嚇了一跳，反身就跑，速度飛快...",
        "一個流氓飛出一把小刀，正中name1屁股，隨着name1的狂奔上下顫抖。",
        ...
        "三個人跑的上氣不接下氣，總算擺脱了流氓。",
        "一個時辰後...",
        "一羣人手持兵器，衝入place，大街小巷中四處搜索。",
        (: create_tiaoxin :),
        "據説the_enemy最近又重新出現在江湖，個個攜帶了武器，一副要找茬的樣子！",
...
({
        ...
        "name2湊到name1耳邊輕聲説到：『看下面的註解，是the_enemy老大和他姘頭哦！』",
        "name2竊竊賊笑：『那可是他手下小嘍羅偷看了畫出來的，不想到了我們手裏，如何？逼真吧？』",
        "name1半天合不上嘴巴，突然叫道：『the_enemy老大幹那事給人偷偷畫下來了？』",
        "name2一把掐住name1脖子，齜牙咧嘴地説：『叫你小聲點！還這麼扯着嗓子嚷嚷，想死啊？』",
        "......",
        "name1面紅氣喘的被name2拖走了。",
...
({
        "name1，name2上山打獵歸來...",
        "name1：『你不是説山上有紅狐狸麼？怎麼連根野雞毛都沒看到？』",
        "name2白白眼睛：『還不是你一路放屁，別説狐狸，老虎都給你臭跑了！』",
        "name1臉一紅，不甘心地分辯着：『你自己也放了一個的，而且是最臭的那個！』",
        "name2飛起一腳，踹在name1的屁股上，name1一把扯住了name2的頭髮....",
         "兩個人打架中......",
         "一個人走下山來，背後披着兩張火紅的狐狸皮。",
        "name1眼睛一亮，對着name2使了個眼神。",
        "name2心領神會，等陌生人走過身邊，突然彎腰撿起一塊石頭衝他後腦勺就是狠狠一下子。",
        "name1衝上前，對準倒在地上的陌生人又用力踹了幾腳！",
        "兩個人得意的奸笑：『這下子不會兩手空空地回去，讓the_party的兄弟笑話了。』",
        "name1和name2一人提着一張狐狸皮揚長而去。",
        "......",
        "一羣人手持兵器，衝入place，大街小巷中四處搜索。",
        (: create_tiaoxin :),
        "據説the_enemy最近又重新出現在江湖，個個攜帶了武器，一副要找茬的樣子！",
...
({
        "name1走在路上，突然前面竄出一個彪形大漢，舉着一把明晃晃的鋼刀！",
        ...
        "『給我記住，以後見到the_party的人最好躲着走路！』，name2揚手又送上了一個大嘴巴。",
        "name1將自己的錢袋掏了回來，順帶把大漢口袋裏的散碎銀兩搜刮一空。",
        "三個人高高興興的去找館子喝酒。",
        "片刻之後...",
        "一羣人手持兵器，衝入place，大街小巷中四處搜索。",
        (: create_tiaoxin :),
