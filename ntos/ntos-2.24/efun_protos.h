...
void f_refs (void);
void f_ansi (void);
void f_ansi_part (void);
void f_remove_ansi (void);
void f_remove_bg_ansi (void);
void f_kill_repeat_ansi (void);
void f_noansi_strlen (void);
...
void f_luan (void);
void f_set_heartbeat_interval (void);
void f_buftostr (void);
void f_strtobuf (void);
...
void f_set (void);
void f_set_temp (void);
void f_query (void);
void f_query_temp (void);
void f_addn (void);
void f_addn_temp (void);
void f_delete (void);
void f_delete_temp (void);
void f_pow (void);
void f_dotprod (void);
...
void f_mb_set (void);
void f_mb_query (void);
void f_mb_delete (void);
...
void f_classes (void);
void f_milli_clock (void);
void f_hash (void);
void f_remove_input_to (void);
